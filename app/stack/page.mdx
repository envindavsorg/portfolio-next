...
} from '../../components/blocs/stars/Stars';
...
<Motion className="mt-6" variants={variantsTwo}>
    <Suspense fallback={<Spinner className="h-32" />}>
...
<Motion className="mt-8" variants={variantsFive} asChild>
    <Accordion type="single" collapsible>
        ...
        <AccordionItem value="tailwind">
            <AccordionTrigger>
                <div className="flex items-center gap-x-2">
                    <TailwindCSSIcon className="size-5 shrink-0" />
                    <span className="text-neutral-600 dark:text-neutral-400">
                        Pourquoi utiliser
                        <span className="text-theme font-extrabold">Tailwind CSS</span> ?
                    </span>
                </div>
            </AccordionTrigger>
            <AccordionContent>
