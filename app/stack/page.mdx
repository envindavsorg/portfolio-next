...
<Motion className="mt-4" variants={variantsOne} asChild>
...
<Motion className="sm:hidden block mt-4" variants={variantsOne} asChild>
    <HowToScroll>
...
<Motion className="mt-4 pb-[68px]" variants={variantsThree}>
    <MostUsedLanguages />
</Motion>
...
<Motion className="mt-4" variants={variantsFive} asChild>
...
<Motion className="mt-4" variants={variantsSix} asChild>
...
<Motion className="mt-12" variants={variantsSeven} asChild>
    ## 4. Base de données (MongoDB ou Postgres)
</Motion>
<Motion className="mt-4" variants={variantsSeven} asChild>
...
<Motion className="mt-12" variants={variantsEight} asChild>
    ## 5. IA (v0, GitHub Copilot et ChatGPT)
</Motion>
<Motion className="mt-4" variants={variantsEight} asChild>
