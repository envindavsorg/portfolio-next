...
<AnimatedNameArticle title="Générer des balises Open Graph dynamiques avec Next.js 14" />
...
J'ai créé un composant **GeneratorOG** pour générer des images **Open Graph** dynamiques.
Vous pouvez le tester en renseignant un titre de publication dans le champ ci-dessous.
