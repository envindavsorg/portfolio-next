		...
		<AnimatePresence>
			{isOpen && (
				<motion.div
					...
					layoutId={`popover-${uniqueId}`}
					className={cn(
						'absolute z-50 overflow-hidden border border-border bg-background outline-none', // Changed z-90 to z-50
						className,
					)}
					style={{
						borderRadius: 12,
...
export function PopoverHeader({
	...
	return (
		<div
			className={cn(
				'px-4 py-2 font-bold font-geist-sans text-sm text-switch md:text-base',
				className,
			)}
		>
			{children}
