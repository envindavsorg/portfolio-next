import { StepIcon, StepIconContainer } from '@/components/step/StepIcon';
import { StepLabel } from '@/components/step/StepLabel';
...
export type IconType = React.ComponentType<any> | undefined;
		...
		return (
			...
			>
				...
				>
					...
					<StepLabel label={label} {...{ isCurrentStep, opacity }} />
				</div>
				<div
					className={cn(
