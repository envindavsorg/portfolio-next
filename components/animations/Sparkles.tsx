	...
	return (
		...
		>
			<SparklesEffect
				...
				minSize={particlesMinSize}
				maxSize={particlesMaxSize}
				speed={particlesSpeed}
				particleDensity={particlesDensity}
...
const SparklesEffect = (props: SparklesEffectProps) => {
	const {
		id,
		className,
		background,
